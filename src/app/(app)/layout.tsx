        ...
        <div className="lg:hidden flex items-center justify-between px-4 py-3 glass-solid">
          <div className="flex items-center gap-3">
            <button
              ...
              className="inline-flex items-center justify-center w-11 h-11 -ml-2 rounded-lg transition-colors hover:bg-[var(--surface-glass)]"
            ...
            <h1 className="text-lg font-display font-semibold" style={{ color: "var(--text-primary)", letterSpacing: "-0.01em" }}>Huset</h1>
          </div>
          <div className="flex items-center gap-1">
            <button
              onClick={() => setSearchOpen(true)}
              aria-label="Sok"
              className="inline-flex items-center justify-center w-11 h-11 rounded-lg transition-all hover:bg-[var(--surface-glass-hover)]"
